 ...
 *
 * @version $Id: DevicePropDesc.java,v 1.6 2000/11/19 22:39:31 dbrownell Exp $
...
public class DevicePropDesc extends Data
{
	...
	out.print (getPropertyName (propertyCode));
	out.print (" = ");
    ...
    /**
     * Maps standard property codes to string names.
    ...
    /**
     * Maps property names to property codes.
