 ...
 *
 * <p> Note that subclasses adding vendor-specific response codes should
 * override getCodeName() to handle those codes, calling to this superclass
 * for all other codes.
 *
 * @version $Id: Response.java,v 1.1 2000/09/14 14:34:18 dbrownell Exp $
...
public class Response extends ParamVector
{
    ...
    {
	return getResponseString (code);
    }

    /**
     * Maps standard response codes to string names.
